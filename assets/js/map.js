...
function initMap() {
	...
	//MapProp variable defines properties of the map
	const mapProp = {
	...
	//Creates a new map inside the div with #map, set it, then calls the properties to see how to render the map
	...
	const myMarks = [{
			...
			"lng": 14.19,
			"name": "Sandhammaren",
			"information": `<div><i class="fas fa-water beach-icon1"<p> Stong winds and great waves. Attention Strong currents!</p></i></div><i class="beach-icon2"></i></div><i class="beach-icon2"></i></div><i class="beach-icon2"></i></div>
		...
		},
		{
			...
			"lng": 14.29,
			"name": "Åhus",
			"information": `<div><i class="fas fa-water beach-icon1"<p> The shallow water are perfect for families with small children</p></i></div><i class="beach-icon2"></i></div><i class="beach-icon2"></i></div><i class="beach-icon2"></i></div>
		...
		},
		{
			...
			"lng": 12.97,
			"name": "Västra Hamnen",
			"information": `<div><i class="fas fa-water beach-icon1"<p> Open air swimming right in the centre of the city</p></i></div><i class="beach-icon2"></i></div><i class="beach-icon2"></i></div><i class="beach-icon2"></i></div>
		...
		},
		{
			...
			"information": `<div><i class="fas fa-water beach-icon1"<p> Shallow clean water, perfect for families</p></i></div><i class="beach-icon2"></i></div><i class="beach-icon2"></i></div><i class="beach-icon2"></i></div>
		...
		},
		{
			"lat": 56.28,
			"lng": 12.50,
			"name": "Mölle och Kullaberg",
			"information": `<div><i class="fas fa-water beach-icon1"<p> Plenty of caves in the cliffs</p></i></div><i class="beach-icon2"></i></div><i class="beach-icon2"></i></div><i class="beach-icon2"></i></div>
		...
		},
		{
			...
			"lng": 14.26,
			"name": "Stenshuvud",
			"information": `<div><i class="fas fa-water beach-icon1"<p> Clear, cold(!) water, be careful of currents</p></i></div><i class="beach-icon2"></i></div><i class="beach-icon2"></i></div><i class="beach-icon2"></i></div>
		...
		},
		{
			...
			"lng": 14.18,
			"name": "Knäbäckshusen",
			"information": `<div><i class="fas fa-water beach-icon1"<p> Shallow shore, you have to walk quite far into the sea to swim.</p></i></div><i class="beach-icon2"></i></div><i class="beach-icon2"></i></div><i class="beach-icon2"></i></div>
		...
		},
		{
			...
			"lng": 12.94,
			"name": "Ribban",
			"information": `<div><i class="fas fa-water beach-icon1"<p> Separate area for dogs and nudists!</p></i></div><i class="beach-icon2"></i></div><i class="beach-icon2"></i></div><i class="beach-icon2"></i></div>
